(function($){$.fn.mdbRate=function(){var $stars;var myDefaultWhiteList=$.fn.tooltip.Constructor.Default.whiteList
  ...
  $stars=$container.children();if($container.hasClass('rating-faces')){$stars.addClass('bi bi-emoji-neutral')}else if($container.hasClass('empty-stars')){$stars.addClass('bi bi-star')}else{$stars.addClass('bi bi-star')}
